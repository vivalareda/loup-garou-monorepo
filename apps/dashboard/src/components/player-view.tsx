...
import { HunterVoteModal } from './hunter-vote-modal';
...
export function PlayerView() {
  ...
  return (
    <div className="flex-1 bg-gray-50 overflow-y-auto">
          ...
          <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="space-y-2.5">
              <div>
                ...
                <div className="text-sm text-gray-800">{activePlayer.name}</div>
              </div>
              <div>
              ...
              {activePlayer.player && (
                <>
                  <details className="mt-2">
                    ...
                    <pre className="mt-2 rounded bg-gray-50 p-2 text-xs overflow-x-auto max-h-40 overflow-y-auto">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-1.5 max-h-48 overflow-y-auto">
                    {activePlayer.playersList
                      ...
                      .map((player) => (
                        <div
                          className={`flex cursor-pointer items-center gap-2 rounded p-2 transition-colors text-sm ${
              ...
              {/* Hunter Actions Section */}
              {activePlayer.status === 'in-game' &&
                activePlayer.player &&
                isGamePlayer(activePlayer.player) &&
                activePlayer.player.role === 'HUNTER' && (
                  <div className="border-t pt-3">
                    ...
                    {activePlayer.player.isAlive ? (
                      ...
                      <div className="rounded bg-gray-100 p-2">
                        <p className="text-xs text-gray-600">
                          💀 Hunter's revenge has been used
                        </p>
                      </div>
                    )}
                  </div>
                ...
                {activePlayer.playersList.map((player) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className={`flex-1 ${isPlayerAlive ? 'text-gray-800' : 'text-gray-500 line-through'}`}
                      >
                        {player.name}
                      </span>
      ...
      {/* Hunter Modal - Show when hunter needs to pick revenge target */}
      <HunterVoteModal playerId={activePlayer.id} />
