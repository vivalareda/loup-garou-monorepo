...
export class InvalidVoteError extends Data.TaggedError('InvalidVoteError')<{
  reason: string;
}> {}

export class TieVoteError extends Data.TaggedError('TieVoteError')<{}> {}

export class NoTargetError extends Data.TaggedError('NoTargetError')<{}> {}
