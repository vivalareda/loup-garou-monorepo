...
export class WerewolvesVote extends Effect.Service<WerewolvesVote>()(
  'WerewolvesVote',
  {
    ...
    effect: Effect.gen(function* () {
      ...
      const registerWerewolfVote = Effect.fn('registerWerewolfVote')(function* (
        ...
        const isWerewolf = werewolves.some(
          (w) => w.getSocketId() === werewolfId
        );
      ...
      const updateWerewolfVote = Effect.fn('updateWerewolfVote')(function* (
        ...
        yield* Effect.log(
          `the werewof ${werewolfId} updated vote to ${victim}`
        );
        const werewolves = yield* game.getWerewolves;
        const isWerewolf = werewolves.some(
          (w) => w.getSocketId() === werewolfId
